...
namespace UnityScript2CSharp.Tests
{
    public partial class Tests
    {
        ...
        public void If()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("if_statement.cs", DefaultUsings + @" public class if_statement : MonoBehaviour { public virtual void F(bool b) { if (b) { return ; } } }");
        ...
        public void If_Else()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("if_else_statement.cs", DefaultUsings + @" public class if_else_statement : MonoBehaviour { public virtual int F(bool b) { if (b) { return 1; } else { return 2; } } }");
        ...
        public void Return_Void()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("return_void.cs", DefaultUsings + @" public class return_void : MonoBehaviour { public virtual void F() { return ; } }");
        ...
        public void Return_Constant()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("return_constant.cs", DefaultUsings + @" public class return_constant : MonoBehaviour { public virtual int F() { return 42; } }");
        ...
        public void Return_Parameter()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("return_constant.cs", DefaultUsings + @" public class return_constant : MonoBehaviour { public virtual int F(int i) { return i; } }");
        ...
        public void Simple_For()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("simple_for.cs", DefaultUsings + @" public class simple_for : MonoBehaviour { public virtual void F() { int i = 1; while (i < 10) { i++; } } }");
        ...
        public void Simple_While()
        {
            ...
            var expectedConvertedContents = SingleSourceFor("simple_while.cs", DefaultUsings + @" public class simple_while : MonoBehaviour { public virtual void F(int i) { while (i < 10) { i++; } } }");
